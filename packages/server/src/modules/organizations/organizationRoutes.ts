...
import { authenticate, requireAdmin, requireOrganization } from "../../middleware/authenticate";
...
router.patch("/:id/services", requireAdmin, (req, res, next) =>
  organizationController.updateServices(req, res, next),
);
